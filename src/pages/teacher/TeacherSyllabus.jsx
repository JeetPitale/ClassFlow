...
export default function TeacherSyllabus() {
  ...
  const toggleComplete = async (id) => {
    try {
      const response = await fetch(`/api/syllabus/topics/${id}/toggle`, {
        method: 'PATCH',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      if (response.ok) {
  ...
  const toggleSubtopicComplete = async (id) => {
    try {
      const response = await fetch(`/api/syllabus/subtopics/${id}/toggle`, {
        method: 'PATCH',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      if (response.ok) {
  ...
  const saveTopic = async () => {
    ...
    try {
      const url = editingTopic
        ? `/api/syllabus/topics/${editingTopic.id}`
        : '/api/syllabus/topics';
  ...
  const deleteTopic = async () => {
    ...
    try {
      const response = await fetch(`/api/syllabus/topics/${deletingTopicId}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      if (response.ok) {
  ...
  const saveSubtopic = async () => {
    ...
    try {
      const url = editingSubtopic
        ? `/api/syllabus/subtopics/${editingSubtopic.id}`
        : '/api/syllabus/subtopics';
  ...
  const deleteSubtopic = async () => {
    ...
    try {
      const response = await fetch(`/api/syllabus/subtopics/${deletingSubtopicId}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      if (response.ok) {
